...
def plot_segmap_ellpreds(image, seg_map, pupil_ellipse, iris_ellipse):
    ...
    # Add green to iris
    out_image[..., 1] = out_image[..., 1] + alphaBlend*loc_iris*loc_image_non_sat

    # Add yellow to pupil

    out_image[..., 0] = out_image[..., 0] + alphaBlend*loc_pupil*loc_image_non_sat
    out_image[..., 1] = out_image[..., 1] + alphaBlend*loc_pupil*loc_image_non_sat
