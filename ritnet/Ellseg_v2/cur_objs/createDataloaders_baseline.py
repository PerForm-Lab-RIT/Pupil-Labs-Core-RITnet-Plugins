...
list_ds = ['NVGaze', 'OpenEDS', 'riteyes-s-general', 'riteyes-s-natural',
           'LPW', 'Fuhl', 'Santini', 'Swirski', 'UnityEyes']
...
for setSel in list_ds:
    ...
    testObj = DataLoader_riteyes(dataDiv_obj, path2h5, 'test', False, (480, 640), scale=0.5)
