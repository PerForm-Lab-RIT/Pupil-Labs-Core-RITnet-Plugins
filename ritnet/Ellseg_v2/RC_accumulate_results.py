...
def get_rc_cmd(exp_name='test',
    ...
    rc_cmd += '--mem=30G --cpus-per-task=4 -p tier3 \
            ...
            -A riteyes --gres=gpu:p4:1 -t 2-0:0:0 '
    return rc_cmd
...
parser.add_argument('--path_acc_results',
                    default='/home/rsk3900/Results/multiset_accumulated_results',
...
parser.add_argument('--exp_cond',
                    default='GR-1.5_AUG-0_ADV_DG-0_IN_NORM-1',
                    help='exact exp condition you want results for',
                    type=str)
parser.add_argument('--growth_rate', type=float, default=1.5,
